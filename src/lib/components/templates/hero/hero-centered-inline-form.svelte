			...
			<div class="text-center sm:flex sm:items-center sm:justify-center sm:text-start">
				<div class="shrink-0 pb-5 sm:flex sm:pe-5 sm:pb-0">
					...
					<div class="flex justify-center -space-x-3">
						...
						{/each}
						<span
							class="inline-flex size-8 items-center justify-center rounded-full bg-gray-800 ring-2 ring-white dark:bg-neutral-900 dark:ring-neutral-900"
						>
				...
				>
					<div class="w-full pb-2 sm:pb-0">
						...
						<Input
							...
							class="border-0 shadow-none focus:border-0 focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
							required
						/>
					</div>
