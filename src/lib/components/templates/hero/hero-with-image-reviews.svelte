<script lang="ts">
	...
	let displayTitle = $derived(highlight ? `${title} ${highlight}` : title);
				...
				<div class="mt-6 grid grid-cols-2 gap-x-5 lg:mt-10">
					{#each reviews as review, index}
						...
						<div class="py-5">
							...
							{#if review.platformLogo}
								<div class="mt-5">
									{#if review.platformLogo === 'google'}
										<!-- Google Logo -->
										<svg
											class="h-auto w-16 text-foreground"
											width="80"
											height="27"
											viewBox="0 0 80 27"
											fill="none"
										...
										<!-- End Google Logo -->
									{:else if review.platformLogo === 'trustpilot'}
										<!-- Trustpilot Logo -->
										<svg
											class="h-auto w-16 text-foreground"
											width="110"
